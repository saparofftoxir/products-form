    ...
    return (
        <div className='w-[500px] flex flex-col items-center m-auto mt-14 h-80 shadow-2xl rounded'>
           ...
           <div className='w-full h-7 flex justify-between px-10 pt-3'>
                <h1 className=' font-bold'>Add Tasks</h1>
            ...
            <form className='w-full gap-3 pt-5 flex flex-col px-10' action="">
                <div>
                    ...
                    <input className='w-full p-1 outline-none border-2 rounded' type="text" placeholder='Enter task name' />
                </div>
                <div>
                    <label htmlFor="">Time:</label>
                    <input className='w-full p-1 outline-none border-2 rounded' type="text" placeholder='Enter task time' />
                </div>
                <div>
